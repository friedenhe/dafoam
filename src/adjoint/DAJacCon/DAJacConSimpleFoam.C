...
defineTypeNameAndDebug(DAJacConSimpleFoam, 0);
addToRunTimeSelectionTable(DAJacCon, DAJacConSimpleFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAJacConSimpleFoam::DAJacConSimpleFoam(
    const fvMesh& mesh)
    : DAJacCon(mesh)
{
    /* 
