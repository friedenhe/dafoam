...
#include "DAStateInfoInterIsoFoam.H"
...
defineTypeNameAndDebug(DAStateInfoInterIsoFoam, 0);
addToRunTimeSelectionTable(DAStateInfo, DAStateInfoInterIsoFoam, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DAStateInfoInterIsoFoam::DAStateInfoInterIsoFoam(
