...
cdef extern from "DASolvers.H" namespace "Foam":
    cppclass DASolvers:
        ...
        void calcdThermaldWTPsiAD(PetscVec, PetscVec, PetscVec, PetscVec)
        void calcdThermaldXvTPsiAD(PetscVec, PetscVec, PetscVec, PetscVec)
        ...
        void calcdRdThermalTPsiAD(PetscVec, PetscVec, PetscVec, PetscVec, PetscVec)
...
cdef class pyDASolvers:
    ...
    def calcdThermaldWTPsiAD(self, Vec xvVec, Vec wVec, Vec psiVec, Vec prodVec):
        self._thisptr.calcdThermaldWTPsiAD(xvVec.vec, wVec.vec, psiVec.vec, prodVec.vec)
    
    def calcdThermaldXvTPsiAD(self, Vec xvVec, Vec wVec, Vec psiVec, Vec prodVec):
        self._thisptr.calcdThermaldXvTPsiAD(xvVec.vec, wVec.vec, psiVec.vec, prodVec.vec)
    ...
    def calcdRdThermalTPsiAD(self, Vec xvVec, Vec wVec, Vec psiVec, Vec thermalVec, Vec prodVec):
        self._thisptr.calcdRdThermalTPsiAD(xvVec.vec, wVec.vec, psiVec.vec, thermalVec.vec, prodVec.vec)
    ...
    def getThermal(self, Vec thermalVec):
        self._thisptr.getThermal(thermalVec.vec)
    
    def setThermal(self, np.ndarray[double, ndim=1, mode="c"] thermal):
